...
import { Background, Parallax } from 'react-parallax';
 ...
 const Landing = (props) => {
  ...
  return(
    ...
    <p class="text-gray-200 mt-3 animate__animated animate__fadeInUp flex flex-wrap   dark:text-gray-400  md:justify-center justify-start md:items-center text-start md:text-center items-start  md:my-4 w-full md:[w-340px]">
    ...
    <div className="text-white flex md:justify-center md:items-center  items-start justify-start  w-full">
        ...
        <button id='Downloadbutton' class="px-5 py-1 flex md:items-center text-center items-start  rounded-full  mt-4 md:m-4 font-bold  border-2 border-white  ">
